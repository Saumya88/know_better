// ignore_for_file: cast_nullable_to_non_nullable, prefer_if_elements_to_conditional_expressions
...
class AdminPhysicalRoom extends StatefulWidget {
  final RoomsDetail roomsDetail;
  final int runNo;
  final Room room;
  const AdminPhysicalRoom({
  ...
  @override
  _AdminPhysicalRoomState createState() => _AdminPhysicalRoomState();
}

class _AdminPhysicalRoomState extends State<AdminPhysicalRoom> {
